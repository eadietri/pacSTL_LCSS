...
```bash
git clone https://github.com/eadietri/pacSTL_LCSS.git
```
...
```bash
python3 examples/quadrotor/quadrotor_example.py
```

**Vessel Navigation pacSTL**

```bash
python3 examples/vessel_navigation/vessel_navigation_example.py
```
